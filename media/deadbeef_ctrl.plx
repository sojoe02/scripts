...
my $deadbeef_service = $bus->get_service("org.mpris.MediaPlayer2.DeaDBeeF");
my $deadbeef_interface = $deadbeef_service->get_object("/org/mpris/MediaPlayer2", "org.mpris.MediaPlayer2.Player");
...
if ($cmd eq 'Next' or $cmd eq 'Previous' or $cmd eq 'PlayPause'){
	...
	$deadbeef_interface->$cmd;
	usleep(500e3);
	my $meta_data = $deadbeef_interface->Metadata();
